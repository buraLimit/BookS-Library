    ...
    def __init__(self, parent, controller):
        ...
        def vratiKnjigu():
            ...
            if korisnik=='' or knjiga=='':
                ...
                try:
                    tekst = konekcija.cursor.callproc('pro_vratiKnjigu', [korisnik, knjiga, ""])
                    konekcija.db.commit()

                    messagebox.showinfo(title='Obavestenje', message=tekst[2])
        ...
        btnIznajmi = ttk.Button(frame, text="Vrati knjigu", width=15, command=vratiKnjigu)
